...
it('can assign wildcard permissions using enums', function () {
    ...
    $articlesCreator = Spatie\Permission\Tests\TestModels\TestRolePermissionsEnum::WildcardArticlesCreator;
    $newsEverything = Spatie\Permission\Tests\TestModels\TestRolePermissionsEnum::WildcardNewsEverything;
    $postsEverything = Spatie\Permission\Tests\TestModels\TestRolePermissionsEnum::WildcardPostsEverything;
    $postsCreate = Spatie\Permission\Tests\TestModels\TestRolePermissionsEnum::WildcardPostsCreate;
    ...
    expect($user1->hasPermissionTo(Spatie\Permission\Tests\TestModels\TestRolePermissionsEnum::WildcardArticlesView))->toBeTrue();
    expect($user1->hasAnyPermission(Spatie\Permission\Tests\TestModels\TestRolePermissionsEnum::WildcardArticlesView))->toBeTrue();

    expect($user1->hasPermissionTo(Spatie\Permission\Tests\TestModels\TestRolePermissionsEnum::WildcardProjectsView))->toBeFalse();

    $user1->revokePermissionTo([$permission1, $permission2, $permission3]);

    expect($user1->hasPermissionTo(Spatie\Permission\Tests\TestModels\TestRolePermissionsEnum::WildcardPostsCreate))->toBeFalse();
    expect($user1->hasPermissionTo($postsCreate->value.'.123'))->toBeFalse();
    expect($user1->hasPermissionTo(Spatie\Permission\Tests\TestModels\TestRolePermissionsEnum::WildcardPostsEverything))->toBeFalse();

    expect($user1->hasPermissionTo(Spatie\Permission\Tests\TestModels\TestRolePermissionsEnum::WildcardArticlesView))->toBeFalse();
    expect($user1->hasAnyPermission(Spatie\Permission\Tests\TestModels\TestRolePermissionsEnum::WildcardArticlesView))->toBeFalse();
