...
class RoleOrPermissionMiddlewareTest extends TestCase
{
    ...
    public function a_client_can_access_a_route_protected_by_permission_or_role_middleware_if_has_this_permission_or_role(): void
    {
        ...
        $this->assertEquals(
            200,
            $this->runMiddleware($this->roleOrPermissionMiddleware, 'clientRole|edit-news|edit-posts')
        );
        ...
        $this->assertEquals(
            200,
            $this->runMiddleware($this->roleOrPermissionMiddleware, 'clientRole|edit-posts')
        );
    ...
    public function client_can_not_access_permission_or_role_with_guard_admin_while_login_using_default_guard(): void
    {
        ...
        $this->assertEquals(
            403,
            $this->runMiddleware($this->roleOrPermissionMiddleware, 'edit-posts|clientRole', 'admin')
        );
    }
