...
use Spatie\Permission\Tests\TestModels\RoleWithNesting;

trait SetupRoleWithNestingTest {
    public static $old_migration;
...
uses(SetupRoleWithNestingTest::class)->group('test');
...
it('returns correct withCount of nested roles', function ($role_group, $index, $relation, $expectedCount) {
