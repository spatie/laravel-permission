...
it('can cache the permissions', function () {
    ...
    assertQueryCount(
        $this->cache_init_count + $this->cache_load_count + $this->cache_run_count
    );
});
...
test('removing a permission from a user should not flush the cache', function () {
...
test('removing a role from a user should not flush the cache', function () {
...
test('user creation should not flush the cache', function () {
    $this->registrar->getPermissions();
...
test('has a permission to should use a cache', function () {
...
test('the cache should differentiate by guard name', function () {
...
test('`getAllPermissions` should use the cache', function () {
...
test('`getAllPermissions` should not over hydrate roles', function () {
